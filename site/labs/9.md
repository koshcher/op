...
Увести з клавіатури рядок алфавітних і цифрових символів. Передбачити меню для виконання таких дій:

- визначити найдовшу послідовність однакових символів в рядку, що йдуть поспіль без розділових символів
- перевірити, чи є рядок симетричним відносно заданих з клавіатури літери чи позиції в рядку
- замінити усі пари однакових символів, що йдуть поспіль, одним символом

Надрукувати усі перетворення рядку, результати перевірки рядка на симетрію.

### Завдання 2

Увести з клавіатури текст, що складається з декількох рядків символів, для створення анаграм та словник слів для перевірки тексту.

Анаграма - це результат перестановки букв слова або фрази, щоб створити нове слово або фразу, використовуючи всі оригінальні літери тільки один раз. Наприклад, апельсин => спаниель.

Визначити, чи є в тексті анаграми, та вивести їх на екран. Показати ланцюжок анаграм.
